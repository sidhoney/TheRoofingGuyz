...
public class TheRoofingGuyzActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(TheRoofingGuyzActivity.this, "Welcome " + user_name, Toast.LENGTH_LONG).show();
        ...
        info.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(TheRoofingGuyzActivity.this, InfoScreen.class);
                TheRoofingGuyzActivity.this.startActivity(i);
            }
        });
        go_to_menu.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                //starting new activity on button click
                Intent i = new Intent(TheRoofingGuyzActivity.this, MenuScreen.class);
                TheRoofingGuyzActivity.this.startActivity(i);
            }
        });
        ...
        findstore.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                //starting new activity on button click
                Intent i = new Intent(TheRoofingGuyzActivity.this, LocateStore.class);
                TheRoofingGuyzActivity.this.startActivity(i);
            }
        });
        go_to_order_list.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                //starting new activity on button click
                Intent i = new Intent(TheRoofingGuyzActivity.this, QuoteList.class);
                TheRoofingGuyzActivity.this.startActivity(i);
            }
        });
